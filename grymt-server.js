...
function loadLevels() {
    ...
    var levelFiles = fs.readdirSync(__dirname + "/levels"),
        i, filename, level;
    ...
    for (i in levelFiles) {
        ...
        try {
            level = require(__dirname + "/levels/" + filename);
...
var webServer = http.createServer(httpApp).listen(8079);
